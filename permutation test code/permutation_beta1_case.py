...
data = pd.read_csv('/ui/abv/liuzx18/project_shapley/simulation_data/beta1_100sims.csv')
...
for sim_id in range(1, 101):
    ...
    data_simulation = data[data['sim_id'] == sim_id].iloc[train_num,]
    data_simulation_test = data[data['sim_id'] == sim_id].iloc[test_num,]
