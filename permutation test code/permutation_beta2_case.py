...
data = pd.read_csv('/ui/abv/liuzx18/project_shapley/simulation_data/beta2_100sims.csv')
...
for sim_id in range(1, 101):
    ...
    data_simulation = data[data['sim_id'] == 1].iloc[train_num,]
    data_simulation_test = data[data['sim_id'] == 1].iloc[test_num,]
